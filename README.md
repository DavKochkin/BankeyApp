...
The first screen from the tabBarList __[MainViewController](https://github.com/DavKochkin/BankeyApp/blob/e6fea6704f43577a3caedb479bcb7d22b40cbd05/Bankey/MainViewController.swift)__. It is an AccountSummaryViewController table, which contains information about the customer's accounts on his bank account. Account data comes from the network.
