...
extension AccountSummaryViewController {
    private func fetchData() {
        ...
        let visa = AccountSummaryCell.ViewModel(accountType: .CreditCar, accountName: "Visa Avion Card", balance: 412.83)
        let masterCard = AccountSummaryCell.ViewModel(accountType: .CreditCar, accountName: "Student MasterCard", balance: 50.83)
